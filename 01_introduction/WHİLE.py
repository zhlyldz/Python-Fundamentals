...
0-100 arasındaki sayıları yazdıralım
sayac=0
while <=100:
    print(sayac)
    sayac+=1
...
Soru:2 ile 100 arasındaki çift ve tek sayıların ayrı ayrı toplamlarını yazdıralım
...
Soru: 1 ile 101 arasındaki tek ve çift sayıların miktarını yazan uygulama yapalım
cift_miktar=0
tek_miktar=0
sayac=1
...
1-1000 arasındaki çift ve tek sayıların toplamlarını yazdıralım
cift_toplam=0
tek_toplam=0
sayac=1
...
VARSA tRUE YOKSA FALSE DÖNECEK
...
KULLANICIDAN YIL BİLGİSİ ALACAĞIZ BU YIL BİLGİSİ 1943 DEĞİLSE ARADIĞINIZ YIL BULUNAMMAKTADIR UYGULAMASI YAZIN
...
0-101 arası tek sayıların toplamını continue kullanarak bul
...
Kullanıcının istediği adım miktarına göre sayıları toplatarak ekrana yazdıralım.
...
sayıdan daha büyük sayı giriniz şeklinde yönlendireceğiz
