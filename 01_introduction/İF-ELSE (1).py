...
#uygulama içerisinde karar mekanizmaları ile belirli bir şart tutması ya da tutmaması durumuna göre farklı kod bkoklarının çalışmasını temin eden yapıdır
