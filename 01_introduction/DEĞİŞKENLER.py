...
#yazılım dillerinde değişkenleri kutulara benzetebilirz.Nasıl ki gündelik hayatımızda kutularda eşyalar saklayabiliyorsak yazılımda değişkenler içerisinde anlık olarak değerler saklayabiliriz

#Diğer programlama dillerinde  değişken tanımlarken ilk önce değişkenin tipini sonra adını sonra da üzerinde değer atarız.burada şu hussusa dikkat etmeliyiz değişkenimizi tanımlarken (declare) bir değişken tipine onu bağladık. Yani uygulama çalıştığı sürece x değişkeninin tipi integerdir.Buradaki önemli nokta artık x değişkenine artık string bir değer ATAYAMAM!
# int x = 10

#pythonda değişken tanımlarken herhangi bir tip belirtmiyoruz.
# x = 10

#bir tip belirtmediğimiz içinj değişkenimiz anlık olarak içerisinde atılan değerlerin tipine bürünmektedir.
# x = "mike tyson"
